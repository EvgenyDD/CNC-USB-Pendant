...
uint8_t usbd_dfu_setup(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req, uint8_t idx)
{
	if(idx != 0) return USBD_FAIL;
	...
	case USB_REQ_TYPE_STANDARD:
		...
		case USB_REQ_SET_INTERFACE:
			if((uint8_t)(req->wValue) < USBD_MAX_NUM_INTERFACES_DFU)
			{
